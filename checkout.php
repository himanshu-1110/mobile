...
if(isset($_POST['submit'])){
	...
	foreach($_SESSION['cart'] as $key=>$val){
		...
		mysqli_query($con,"insert into `order_details`(order_id,model_id,qty,price) values('$order_id','$key','$qty','$price')");
	}
                            ...
                            <div class="order-details__item">
								...
								<div class="single-item">
                                    <div class="single-item__thumb">
                                        <img src="<?php echo MODEL_IMAGE_SITE_PATH.$image?>"  />
                                    </div>
